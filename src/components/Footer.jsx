...
const Footer = () => (
    <footer className={`${style.flexCenter}
    ${style.paddingY} flex-col `} >
      ...
      md:flex-row flex-col mb-8 w-full `} >
       ...
       mt-4 max-w-[310px]`} >
        A new way to make the payement easy , reliable and secure
       </p>
       </div>
      ...
      md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45] '  >
        ...
        leading-[27px] text-center text-white ' >
          2021 HooBank . &copy; All Right Reserved
        </p>
        <div className='flex flex-row md:mt-0 mt-6' >
       {socialMedia.map((social,index)=>(
        <img src={social.icon} key={social.id} 
        alt={social.id} className={`w-[21px] h-[21px] object-contain
